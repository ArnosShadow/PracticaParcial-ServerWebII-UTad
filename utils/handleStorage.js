...
const uploadMiddleware = multer({storage, limits:{fileSize: 50000*1024*1024}});
//Middleware entre la ruta y el controlador

const memory = multer.memoryStorage()
const uploadMiddlewareMemory = multer({storage:memory, limits:{fileSize: 50000*1024*1024}})
